...
public class ClientIT {
    ...
    public static Long NEW_CLIENT_ID = 5L;
    public static String NEW_CLIENT_NAME = "CLIENT 5";
    ...
    public void deleteWithExistsIdShouldDeleteClient() {
        restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + "/" + DELETE_CLIENT_ID, HttpMethod.DELETE, null, responseType);
