...
public class ClientTest {
    ...
    @Test
    public void saveExistsClientIdShouldInsert() throws Exception {
    ...
    Long DELETE_CLIENT_ID = 3L;

    @Test
    public void deleteExistsClientIdShouldDelete() throws Exception {

        Client client = mock(Client.class);
        when(clientRepository.findById(DELETE_CLIENT_ID)).thenReturn(Optional.of(client));
        clientService.delete(DELETE_CLIENT_ID);

        verify(clientRepository).deleteById(DELETE_CLIENT_ID);
    }
